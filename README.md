...
Analyze churn patterns based on contract type, payment method, and tenure
...
Pandas & Matplotlib – Data manipulation and exploratory analysis
...
Month-to-month contracts experience significantly higher churn compared to one-year and two-year contracts.

Customers using electronic checks have the highest churn rates, while automated payment methods such as credit cards and bank transfers show stronger retention.

Most churn occurs within the first 6–12 months of customer tenure, highlighting the importance of early engagement and onboarding.
...
Overall churn and retention metrics
...
Retention drivers through contract and payment segmentation
...
Promote automated payment methods to reduce churn associated with manual payments.

Strengthen onboarding and early engagement strategies during the first year of subscription.
